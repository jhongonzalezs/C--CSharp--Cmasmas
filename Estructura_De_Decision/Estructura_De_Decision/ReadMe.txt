========================================================================
    APLICACIÓN DE CONSOLA: Estructura_De_Decision Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Estructura_De_Decision.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Estructura_De_Decision.


Estructura_De_Decision.vcxproj
...
Estructura_De_Decision.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Estructura_De_Decision.pch y un archivo de tipos precompilados llamado StdAfx.obj.
